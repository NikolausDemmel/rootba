...
from .latex.overview_table import OverviewTable
...
def main():
    ...
    parser = argparse.ArgumentParser("Load rootba experiment logs and generate result tables and plots.")
